...
warm_up_set=("2")
patience_set=("1")
gain_threshold_set=("0.2" "0.5" "1.0")
...
SUFFIX="lr${LR}_b${BATCH_SIZE}_ga${GRAD_ACC}_alpha${ALPHA}_e${EPOCHS}_ies_normnll_gain_ge${GAIN_THRESHOLD}_warm${WARM_UP}_patience${PATIENCE}_rebounddelta${REBOUND_DELTA}_rpat${REACTIVATION_PATIENCE}_samplingbaseline_masked"
...
echo "============================================================" | tee -a "${LOG_FILE}"
echo "MUSE ${DATA_SPLIT} NPO sample early stop with rebound" | tee -a "${LOG_FILE}"
