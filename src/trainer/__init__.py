...
from trainer.unlearn.sample_early_stop_grad_diff_marginal_ratio import SampleEarlyStopGradDiffMarginalRatio
...
from trainer.unlearn.sample_early_stop_simnpo_marginal_ratio_drop_stopped import SampleEarlyStopSimNPOMarginalRatioDropStopped
from trainer.unlearn.sample_early_stop_wga_irreversible import SampleEarlyStopWGAIrreversible
from trainer.unlearn.sample_early_stop_wga_marginal_ratio import SampleEarlyStopWGAMarginalRatio
...
_register_trainer(SampleEarlyStopGradDiffMarginalRatio)
_register_trainer(SampleEarlyStopSimNPOIrreversible)
_register_trainer(SampleEarlyStopSimNPOMarginalRatio)
_register_trainer(SampleEarlyStopSimNPOMarginalRatioDropStopped)
_register_trainer(SampleEarlyStopWGAIrreversible)
_register_trainer(SampleEarlyStopWGAMarginalRatio)
